<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddQuestion2.aspx.cs" Inherits="ExamSystem.AddQuestion2" %>
     ...
     <p>
        ...
        <table style="height: 140px; width: 667px">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtquestionset" runat="server" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 304px">
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="Button2" runat="server" Height="38px" OnClick="Button2_Click" Text="Finish" Width="165px" />

                </td>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Next" OnClick="Button1_Click" Height="31px" Width="165px" />
                </td>
            </tr>
        </table>
    </form>
